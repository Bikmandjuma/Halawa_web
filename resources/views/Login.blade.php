...
<html lang="en">
  ...
  /*        width: 70%; */
      ...
      .containers form input[placeholder="Enter email"]{
        margin-right: 20px;
      }
             ...
             <div class="card_profile">  
                <div class="card">              
                    ...
                    <div class="containers">
                      ...
                      <a href="#ForgotPassword" class="pt-3"><i class="fas fa-key"></i> Forgot password</a>
                    </div>
                </div>
            </div>
