...
<html lang="en">
  <head>
    <title>Halawat muslims Check-code</title>
    <meta charset="utf-8">
               ...
               <div class="card_profile">  
                  <div class="card">              
                      <div class="card_title">
                        <h3><i class="fas fa-anvelope"></i>Check code</h3>
                      </div>
                      ...
                      <div class="containers">
                        ...
                        <a href='{{url("ResendCode")}}/{{session("email")}}'>Didn't get a code , resend it again !</a>
                        <br>
                      </div>
                  </div>
              </div>
